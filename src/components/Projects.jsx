...
This Metronic-based website showcases my development skills with its sleek design.</p>
              <div className="flex justify-between mt-4">
 ...
 <a href="https://github.com/Johnkennedyb/Blossom"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 focus:outline-none focus:bg-gray-900">Github</button></a> 
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec molestie velit vitae nibh.</p>
              <div className="flex justify-between mt-4">
