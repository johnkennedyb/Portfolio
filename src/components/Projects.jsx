 ...
 <a href="https://github.com/johnkennedyb/punch-zwilt"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Github</button></a> 
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between mt-4">
 <a href="https://netflix-clone-delta-weld.vercel.app/"> <button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Live Demo</button></a> 
 <a href="https://github.com/johnkennedyb/netflix-clone"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Github</button></a> 
</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between mt-4">
 <a href="https://metronix.vercel.app/"> <button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Live Demo</button></a> 
 <a href="https://github.com/Johnkennedyb/Blossom"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Github</button></a> 
</div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between mt-4">
  <a href="https://evon-v8mc.vercel.app/"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Live Demo</button></a>
 <a href="https://Github.Com/Johnkennedyb/Evon"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Github</button></a> 
</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between mt-4">
  <a href="https://blackcofferreact.onrender.com/"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Live Demo</button></a>
  <a href="https://Github.Com/Johnkennedyb/Blackcofferfrontend"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:bg-gray-900 hover:text-white focus:outline-none focus:bg-gray-900">Github</button></a>
</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between mt-4">
  <a href="https://michellemorrislpc.com/"><button className="px-4 py-2 bg-yellow-500 text-black rounded hover:text-white hover:bg-gray-900 focus:outline-none focus:bg-gray-900">Live Demo</button></a>
